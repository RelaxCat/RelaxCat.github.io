var projects = [
  {
    ...
    projectImage:
      '../banner/techden-banner.png, ../banner/techden-banner2.png, ../banner/techden-banner3.png',
    ...
    projectIntroduction:
      'Welcome to "The Tech Den," your one-stop destination for all things tech! We are delighted to introduce you to a world of cutting-edge technology and computing essentials. At The Tech Den, we understand the evolving needs of tech enthusiasts, gamers, professionals, and everyday users who rely on their computers for work and play.',
    projectBackground:
  ...
  },
  {
    ...
    projectImage:
      '../banner/weathernow-banner.png, ../banner/weathernow-banner2.png, ../banner/weathernow-banner3.png',
    projectType:
      'Weather App Development for Real-Time Weather Updates and Forecasts',
    projectCategory: 'Website, Featured, UI/UX Design',
    projectDate: '17 Oct 2023',
    projectDescription:
      "The Weather App provides up-to-the-minute weather updates and current conditions to keep you informed about what's happening in your area",
  ...
  },
  {
    ...
    projectLogo: '',
    projectImage:
      '../banner/achordly-banner.png, ../banner/achordly-banner2.png, ../banner/achordly-banner3.png',
    projectType: 'UI/UX Design for Achord.ly Music Application',
    projectCategory: 'UI/UX Design',
    projectDate: '15 Oct 2023',
    projectDescription:
      'Achord.ly simplifies the process of exploring a wide range of musical chords and video tutorials, enhancing your musical journey with ease and convenience.',
    projectTool: 'Figma',
    projectLink: '',
    downloadLink: '',
    projectIntroduction:
    ...
    projectSummary:
      'As the initial step, the focus will be on developing a mobile application for Android and iOS operating systems, aptly named Achord.ly. This application, in essence, will serve as a reservoir for chords, offering users a vast library of chord progressions for their favorite songs, complemented by instructional video tutorials on how to play them.',
    projectWebsite: '',
    projectPrototype:
      'https://www.figma.com/embed?embed_host=share&url=https%3A%2F%2Fwww.figma.com%2Fproto%2FD8EMvwBjYH9hW726z1Ikls%2FAchord.ly%3Fnode-id%3D1-164%26starting-point-node-id%3D1%253A2%26scaling%3Dscale-down%26mode%3Ddesign%26t%3DPaz9VP5qZ23CdkuG-1',
    projectProtoLink:
      'https://www.figma.com/proto/D8EMvwBjYH9hW726z1Ikls/Achord.ly?node-id=1-164&starting-point-node-id=1%3A2&mode=design&t=Paz9VP5qZ23CdkuG-1',
  },
  {
    projectId: '',
    projectName: '',
